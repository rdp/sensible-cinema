...
def subcategory_map
   # "end consumer friendly": "creator instructions" (and the double dash is needed...)
    ...
    "collision": "violence -- collision/crash (no explicit human death)",
    "explosion": "violence -- explosion (no explicit human death)",
    ...
    "shooting hit non death": "violence -- shooting hits person but non fatal",
