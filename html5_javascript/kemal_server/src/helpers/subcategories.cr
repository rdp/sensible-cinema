...
def subcategory_map
  ...
  "violence": [
    ...
    {db_name: "visible blood", human_name: "visible blood (ex: blood from earlier wound)", sub_sub_cat: ""},
    {db_name: "visible dried blood", human_name: "visible dried blood +- bandage (from earlier wound)", sub_sub_cat: ""},
    ...
    {db_name: "killing", human_name: "killing on screen (ex: shooting, fatal) victim visible", sub_sub_cat: ""},
    {db_name: "killing no victim", human_name: "killing on screen (ex: shooting, fatal) victim not visible", sub_sub_cat: ""},
    {db_name: "killing offscreen", human_name: "killing off screen (ex: shooting death off screen, just audio)", sub_sub_cat: ""},
  ...
  #  {db_name: "partial nudity", human_name: "partial nudity (ex: excessive cleavage)", sub_sub_cat: ""},
    ...
    {db_name: "nudity anterior male", human_name: "nudity (anterior) male [genital]", sub_sub_cat: ""},
    {db_name: "nudity anterior female", human_name: "nudity (anterior) female [genital]", sub_sub_cat: ""},
  ...
  #  {db_name: "shirtless male", human_name: "shirtless male (+- sexual)", sub_sub_cat: ""},
    {db_name: "shirtless male front", human_name: "shirtless male front (+- sexual)", sub_sub_cat: ""},
