...
#  {db_name: "shirtless male", human_name: "shirtless male (non sexual or sexual)", sub_sub_cat: ""},
  {db_name: "shirtless male front", human_name: "shirtless male (non sexual or sexual) front", sub_sub_cat: ""},
  {db_name: "shirtless male back", human_name: "shirtless male (non sexual or sexual)" back, sub_sub_cat: ""},
