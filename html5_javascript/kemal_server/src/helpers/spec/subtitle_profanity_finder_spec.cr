...
describe SubtitleProfanityFinder do
  ...
  describe "parse amazon" do
    ...
    it "should replace html right" do
      a = SubtitleProfanityFinder.translate_amazon_line_to_entry("<p begin=\"00:20:48.769\" end=\"00:20:51.119\" region=\"AmazonDefaultRegion\" style=\"AmazonDefaultStyle\">I guess I like Brooklyn not<br />being sucked into a black hole.</p>").not_nil!
      a[:text].should eq "I guess I like Brooklyn not being sucked into a black hole."
    end
