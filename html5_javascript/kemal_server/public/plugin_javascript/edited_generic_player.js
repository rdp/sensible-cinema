...
function getEndSpeed(value) {
  ...
  // some failure
  if (isYoutubePimw()) {
      alert("you need to enter the speed you want in the details like 'my_details 2.0x' or 'my_details 0.5x' (options:" +  youtube_pimw_player.getAvailablePlaybackRates() + " x )");
  } else {
