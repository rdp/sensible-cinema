...
settings = [
  ...
  {type: :new_releases, title: "Movies Rent/Purchase", urls: new_releases, message: "Movies and new releases for rent/purchase"},
...
def get_in_works(all_urls)
  ...
  puts "sort=", in_works.map{|u| u.name =~ /game of thrones/i}
