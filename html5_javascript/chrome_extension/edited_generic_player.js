...
<select name="subcategory" id='subcategory_select_id' style="background-color: rgba(255, 255, 255, 0.85);" onchange="">
    <option value="">please select subcategory</option> <!-- this one sticks around no matter which category you select -->
          ...
          <option value="lewd action">physical -- lewd or suggestive action lesser</option>    
          ...
          <option value="">physical -- for violent sex choose rape in violence category</option>    
          ...
          <option value="drug injection">substance-abuse -- illegal drug use injection</option>    
        
          <option value="medicinal injection">substance-abuse -- medicinal drug use injection</option>    
