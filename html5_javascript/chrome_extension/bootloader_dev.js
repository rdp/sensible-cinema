...
function checkAndLoadEditor() {
  ...
  if (video_element && (currentUrl != clean_stream_extension_old_url || getCurrentAmazonEpisode() != clean_stream_extension_old_amazon_episode) && !currentUrl.includes("facebook.com")) {
    var loaded=false;
...
if (video_element == null)
  alert('you requested edited playback but no movie found on current page.\nWill be unable to play edited...'); // this should never happen anymore on the big 3 anyway :|
